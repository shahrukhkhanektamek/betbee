...
<table class="table table-bordered table-striped">
    ...
    <tbody>
        ...
        <tr id="rowno<?=$value->id ?>">
           ...
           <td><?=$value->stop_before_minute ?></td>
           ...
           <td class="text-end action-td" >
               ...
               <?php if(empty($is_delete)){ ?>
                    ...
                    <a href="<?=base_url(panel.'/sessions/list/'.$value->id) ?>" class="badge btn btn-primary"><i class="far fa-eye mr-1"></i> View</a>
