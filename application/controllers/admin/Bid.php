...
class Bid extends CI_Controller {
   ...
   protected $arr_values = array(
						   	...
						   	'table_name'=>'game_bet',
						   	'page_title'=>'Bid',
						   	"submit_url"=>panel.'/bid/update',
						   	"folder_name"=>'bid',
						   	"upload_path"=>'upload/',
						   	"back_btn"=>panel.'/bid',
						   	"btn_url"=>panel.'/bid/add',
						   	"add_btn_url"=>panel.'/bid/add',
						   	"edit_btn_url"=>panel.'/bid/edit/',
						   	"plan_btn_url"=>panel.'/booking/index/',
						   	"view_btn_url"=>panel.'/bid/view/',
						   	"controller_name"=>'bid',
						   	"page_name"=>'bid-detail.php',
