...
class Single_pana extends CI_Controller {

   protected $arr_values = array(
						   	'title'=>'Single Pana', 
						   	'table_name'=>'single_pana',
						   	'page_title'=>'Single Pana',
						   	"submit_url"=>panel.'/single_pana/update',
						   	"folder_name"=>'single_pana',
						   	"upload_path"=>'upload/',
						   	"back_btn"=>panel.'/single_pana',
						   	"btn_url"=>panel.'/single_pana/add',
						   	"add_btn_url"=>panel.'/single_pana/add',
						   	"edit_btn_url"=>panel.'/single_pana/edit/',
						   	"view_btn_url"=>panel.'/single_pana/view/',
						   	"controller_name"=>'single_pana',
						   	"page_name"=>'single_pana-detail.php',
						   	"keys"=>'id,name',
