...
class Avtar extends CI_Controller {

   protected $arr_values = array(
						   	'title'=>'Avtar', 
						   	'table_name'=>'avtar',
						   	'page_title'=>'Avtar',
						   	"submit_url"=>panel.'/avtar/update',
						   	"folder_name"=>'avtar',
						   	"upload_path"=>'upload/',
						   	"back_btn"=>panel.'/avtar',
						   	"btn_url"=>panel.'/avtar/add',
						   	"add_btn_url"=>panel.'/avtar/add',
						   	"edit_btn_url"=>panel.'/avtar/edit/',
						   	"view_btn_url"=>panel.'/avtar/view/',
						   	"controller_name"=>'avtar',
						   	"page_name"=>'avtar-detail.php',
						   	"keys"=>'id,name',
