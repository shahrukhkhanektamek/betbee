                                         ...
                                         <div class="col-md-3">
                                            <div class="navbar-item navbar-form">
                                                  <div class="form-group">
                                                      <input type="number" class="form-control" placeholder="Enter Amount" id="amount<?=$table_id ?>" data-table_id="<?=$table_id ?>" >
                                                  </div>
                                            </div>
                                         </div>
                                         <div class="col-md-2">
                                            <button type="button" class="btn btn-primary amount-submit-btn" data-table_id="<?=$table_id ?>">Submit</button>
                                         </div>
...
<script>
   ...
   $(document).on("change", ".select-user, .statuschange, .order_bychange, .limitchange, .kycchange, .time_idchange, .cardidchange, .datechange",(function(e) {
