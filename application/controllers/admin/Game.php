...
class Game extends CI_Controller {
   ...
   protected $arr_values = array(
						   	'title'=>'Timer Setting', 
						   	'table_name'=>'game',
						   	'page_title'=>'Timer Setting',
						   	"submit_url"=>panel.'/game/update',
						   	"folder_name"=>'game',
						   	"upload_path"=>'upload/',
						   	"back_btn"=>panel.'/game',
						   	"btn_url"=>panel.'/game/add',
						   	"add_btn_url"=>panel.'/game/add',
						   	"edit_btn_url"=>panel.'/game/edit/',
						   	"view_btn_url"=>panel.'/game/view/',
						   	"controller_name"=>'game',
						   	"page_name"=>'game-detail.php',
						   	"keys"=>'id,name',
	...
	public function update($id="")
	{
      ...
      $type2 = $this->input->post('type2');
	   ...
	   $user_data = array(
			...
			"total_minute"=>$this->input->post('total_minute'),
			"stop_before_minute"=>$this->input->post('stop_before_minute'),
			"status"=>$status,
	   );
