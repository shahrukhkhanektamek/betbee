...
class Half_sangam extends CI_Controller {

   protected $arr_values = array(
						   	'title'=>'Half Sangam', 
						   	'table_name'=>'half_sangam',
						   	'page_title'=>'Half Sangam',
						   	"submit_url"=>panel.'/half_sangam/update',
						   	"folder_name"=>'half_sangam',
						   	"upload_path"=>'upload/',
						   	"back_btn"=>panel.'/half_sangam',
						   	"btn_url"=>panel.'/half_sangam/add',
						   	"add_btn_url"=>panel.'/half_sangam/add',
						   	"edit_btn_url"=>panel.'/half_sangam/edit/',
						   	"view_btn_url"=>panel.'/half_sangam/view/',
						   	"controller_name"=>'half_sangam',
						   	"page_name"=>'half_sangam-detail.php',
						   	"keys"=>'id,name',
