...
class Full_sangam extends CI_Controller {

   protected $arr_values = array(
						   	'title'=>'Full Sangam', 
						   	'table_name'=>'full_sangam',
						   	'page_title'=>'Full Sangam',
						   	"submit_url"=>panel.'/full_sangam/update',
						   	"folder_name"=>'full_sangam',
						   	"upload_path"=>'upload/',
						   	"back_btn"=>panel.'/full_sangam',
						   	"btn_url"=>panel.'/full_sangam/add',
						   	"add_btn_url"=>panel.'/full_sangam/add',
						   	"edit_btn_url"=>panel.'/full_sangam/edit/',
						   	"view_btn_url"=>panel.'/full_sangam/view/',
						   	"controller_name"=>'full_sangam',
						   	"page_name"=>'full_sangam-detail.php',
						   	"keys"=>'id,name',
