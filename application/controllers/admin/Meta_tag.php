...
class Meta_tag extends CI_Controller {
   ...
   protected $arr_values = array(
						   	...
						   	'page_title'=>'Meta Tag',
						   	"submit_url"=>panel.'/meta_tag/update',
						   	"folder_name"=>'meta_tag',
						   	"upload_path"=>'upload/',
						   	"back_btn"=>panel.'/meta_tag',
						   	"btn_url"=>panel.'/meta_tag/add',
						   	"add_btn_url"=>panel.'/meta_tag/add',
						   	"edit_btn_url"=>panel.'/meta_tag/edit/',
						   	"view_btn_url"=>panel.'/meta_tag/view/',
						   	"controller_name"=>'meta_tag',
						   	"page_name"=>'meta_tag.php',
						   	"keys"=>'id,page_name',
   ...
   public function __construct()
	...
	public function load_data()
	{
		...
		$where_query .= " status='$status' and is_delete='$is_delete' and type='1' ";
	...
	public function update($id="")
	{
      ...
      $user_data = array();
     	...
     	$slug_array = explode(base_url(), $this->input->post('slug'));
     	...
     	if(strtolower($slug)=='index' || strtolower($slug)=='home' || strtolower($slug)=='home page' || empty($slug))
     	{
      	$slug = slug('home');
     	}
     	else
	   ...
	   $user_data = array(
			...
			if(!empty($this->db->select('slug')->limit(1)->where(" id!='$id' ")->get_where("meta_tags",array("slug"=>$slug,))->result_object()))
			{
				$result['message'] = "This slug allready exist!";
            $result['status']  = "400";
            $result['action']  = "add";
