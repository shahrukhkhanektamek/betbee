...
class Sessions extends CI_Controller {
   ...
   protected $arr_values = array(
						   	...
						   	'page_title'=>'Session',
						   	"submit_url"=>panel.'/sessions/update',
						   	"folder_name"=>'sessions',
						   	"upload_path"=>'upload/',
						   	"back_btn"=>panel.'/sessions',
						   	"btn_url"=>panel.'/sessions/add',
						   	"add_btn_url"=>panel.'/sessions/add',
						   	"edit_btn_url"=>panel.'/sessions/edit/',
						   	"view_btn_url"=>panel.'/betting/index/',
						   	"controller_name"=>'sessions',
						   	"page_name"=>'sessions-detail.php',
						   	"keys"=>'id,name',
   ...
   public function __construct()
	...
	public function list($id)
	{
		...
		$game_data = $this->db->get_where("game",array("id"=>$id,))->result_object();
		if(!empty($game_data))
		{
	...
	public function load_data()
	{
		...
		$where_query .= "date_time <= $crtime and game_id='$game_id' and ";

		$where_query .= " status='$status' and is_delete='$is_delete' and game_id='$game_id' ";
		if(!empty($pending)) $where_query .= " and is_result_declare='0' ";
