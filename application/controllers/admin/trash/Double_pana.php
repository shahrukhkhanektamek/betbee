...
class Double_pana extends CI_Controller {

   protected $arr_values = array(
						   	'title'=>'Double Pana', 
						   	'table_name'=>'double_pana',
						   	'page_title'=>'Double Pana',
						   	"submit_url"=>panel.'/double_pana/update',
						   	"folder_name"=>'double_pana',
						   	"upload_path"=>'upload/',
						   	"back_btn"=>panel.'/double_pana',
						   	"btn_url"=>panel.'/double_pana/add',
						   	"add_btn_url"=>panel.'/double_pana/add',
						   	"edit_btn_url"=>panel.'/double_pana/edit/',
						   	"view_btn_url"=>panel.'/double_pana/view/',
						   	"controller_name"=>'double_pana',
						   	"page_name"=>'double_pana-detail.php',
						   	"keys"=>'id,name',
