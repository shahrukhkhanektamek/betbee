...
class Triple_pana extends CI_Controller {

   protected $arr_values = array(
						   	'title'=>'Triple Pana', 
						   	'table_name'=>'triple_pana',
						   	'page_title'=>'Triple Pana',
						   	"submit_url"=>panel.'/triple_pana/update',
						   	"folder_name"=>'triple_pana',
						   	"upload_path"=>'upload/',
						   	"back_btn"=>panel.'/triple_pana',
						   	"btn_url"=>panel.'/triple_pana/add',
						   	"add_btn_url"=>panel.'/triple_pana/add',
						   	"edit_btn_url"=>panel.'/triple_pana/edit/',
						   	"view_btn_url"=>panel.'/triple_pana/view/',
						   	"controller_name"=>'triple_pana',
						   	"page_name"=>'triple_pana-detail.php',
						   	"keys"=>'id,name',
