...
class Game_card extends CI_Controller {

   protected $arr_values = array(
						   	'title'=>'Game card', 
						   	'table_name'=>'game_card',
						   	'page_title'=>'Game card',
						   	"submit_url"=>panel.'/game_card/update',
						   	"folder_name"=>'game_card',
						   	"upload_path"=>'upload/',
						   	"back_btn"=>panel.'/game_card',
						   	"btn_url"=>panel.'/game_card/add',
						   	"add_btn_url"=>panel.'/game_card/add',
						   	"edit_btn_url"=>panel.'/game_card/edit/',
						   	"view_btn_url"=>panel.'/game_card/view/',
						   	"controller_name"=>'game_card',
						   	"page_name"=>'game_card-detail.php',
						   	"keys"=>'game_card.id,game_card.name',
   ...
   public function __construct()
	...
	public function load_data()
	{
		...
		$where_query .= " game_card.status='$status' and game_card.is_delete='$is_delete' and game_card.game_id='$game_id' ";
		...
		$this->db
			->select("game_card.id as id")
			->select("game.name as game_name")
			->select("game_card.status as status")
			->select("card.name as name")
			->select("card.image as image")
			->select("game_card.category_card_id as category_card_id")
			->join("card as card","card.id=game_card.card_id","LEFT")
			->join("game as game","game.id=game_card.game_id","LEFT");
