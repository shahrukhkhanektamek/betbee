                        ...
                        <div class="col-12">
                            <div class="card">
                               <div class="card-header" style="padding-bottom: 0;">
                                ...
                                <div class="row">
                                    <h2 style="font-weight: 800;text-align: center;width: 100%;text-align-last: justify;">
                                        <!-- List -->
                                        <button class="btn btn-danger" id="all-btn">All</button>
                                        <button class="btn btn-danger" id="pending-btn">Pending Results</button>
                                    </h2>
                                </div>
                                    ...
                                    <div class="row" style="display: none;">
                                        ...
                                        <div class="col-md-4 text-right" style="text-align: right;">
                                            <?php if(trash==true && empty($trash)){ ?>
                                                <a href="<?=($back_btn) ?>?trash=1" class="btn btn-danger add-button ml-3" style="margin-left: 15px;padding: 5px 5px;"><i class="fa fa-trash"></i></a>
                                            <?php }else{ ?>
                                                <a href="<?=($back_btn) ?>" class="btn btn-success add-button ml-3 list-btn" style="margin-left: 15px;padding: 5px 5px;"><i class="fa fa-bars"></i>&nbsp;&nbsp;All</a>
                                            <?php } ?>
...
<script>
   ...
   var page = 1;
   var pending = "<?=$this->input->get('pending') ?>";
   var data = [];
   var keys_url = {};
