...
class Jodi_digit extends CI_Controller {

   protected $arr_values = array(
						   	'title'=>'Jodi Digit', 
						   	'table_name'=>'jodi_digit',
						   	'page_title'=>'Jodi Digit',
						   	"submit_url"=>panel.'/jodi_digit/update',
						   	"folder_name"=>'jodi_digit',
						   	"upload_path"=>'upload/',
						   	"back_btn"=>panel.'/jodi_digit',
						   	"btn_url"=>panel.'/jodi_digit/add',
						   	"add_btn_url"=>panel.'/jodi_digit/add',
						   	"edit_btn_url"=>panel.'/jodi_digit/edit/',
						   	"view_btn_url"=>panel.'/jodi_digit/view/',
						   	"controller_name"=>'jodi_digit',
						   	"page_name"=>'jodi_digit-detail.php',
						   	"keys"=>'id,name',
