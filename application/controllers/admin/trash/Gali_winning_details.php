...
class Gali_winning_details extends CI_Controller {

   protected $arr_values = array(
						   	'title'=>'Gali Winning detail', 
						   	'table_name'=>'game_winners',
						   	'page_title'=>'Gali Winning detail',
						   	"submit_url"=>panel.'/gali_winning_details/update',
						   	"folder_name"=>'gali_winning_details',
						   	"upload_path"=>'upload/',
						   	"back_btn"=>panel.'/gali_winning_details',
						   	"btn_url"=>panel.'/gali_winning_details/add',
						   	"add_btn_url"=>panel.'/gali_winning_details/add',
						   	"edit_btn_url"=>panel.'/gali_winning_details/edit/',
						   	"plan_btn_url"=>panel.'/booking/index/',
						   	"view_btn_url"=>panel.'/gali_winning_details/view/',
						   	"controller_name"=>'gali_winning_details',
						   	"page_name"=>'gali_winning_details-detail.php',
