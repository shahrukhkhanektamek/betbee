...
<table class="table table-bordered table-striped">
    ...
    <tbody>
        ...
        <tr id="rowno<?=$value->id ?>">
           ...
           {
            echo str_replace(" ", "_", $value->game_name);
           }
            ?></td>           
           ...
           <td>
                <?php
                    if(empty($value->close_number))echo '*';else echo $value->close_number;
                    if(!empty(($value->close_single_number)))echo '-'.$value->close_single_number;else echo '-*';
                ?>
           </td>          
