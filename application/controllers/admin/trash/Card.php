...
class Card extends CI_Controller {
   ...
   protected $arr_values = array(
						   	...
						   	'table_name'=>'card',
						   	'page_title'=>'Card',
						   	"submit_url"=>panel.'/card/update',
						   	"folder_name"=>'card',
						   	"upload_path"=>'upload/',
						   	"back_btn"=>panel.'/card',
						   	"btn_url"=>panel.'/card/add',
						   	"add_btn_url"=>panel.'/card/add',
						   	"edit_btn_url"=>panel.'/card/edit/',
						   	"view_btn_url"=>panel.'/card/view/',
						   	"controller_name"=>'card',
						   	"page_name"=>'card-detail.php',
						   	"keys"=>'card.id,card.name',
   ...
   public function __construct()
	...
	public function load_data()
	{
		...
		$where_query .= " card.status='$status' and card.is_delete='$is_delete' ";
