...
class Game_number extends CI_Controller {

   protected $arr_values = array(
						   	'title'=>'Game Number', 
						   	'table_name'=>'single_digit',
						   	'page_title'=>'Game Number',
						   	"submit_url"=>panel.'/game_number/update',
						   	"folder_name"=>'game_number',
						   	"upload_path"=>'upload/',
						   	"back_btn"=>panel.'/game_number',
						   	"btn_url"=>panel.'/game_number/add',
						   	"add_btn_url"=>panel.'/game_number/add',
						   	"edit_btn_url"=>panel.'/game_number/edit/',
						   	"view_btn_url"=>panel.'/game_number/view/',
						   	"controller_name"=>'game_number',
						   	"page_name"=>'game_number-detail.php',
						   	"keys"=>'id,name',
   ...
   public function __construct()
	...
	public function view($id="")
	{
		...
		if(!empty($row))
		{
			...
			$data['game_number_availability'] = $this->db->get_where("game_number_availability",array("vendor_id"=>$row[0]->vendor_id,))->result_object();
