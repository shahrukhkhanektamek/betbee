...
class Single_digit extends CI_Controller {

   protected $arr_values = array(
						   	'title'=>'Single Digit', 
						   	'table_name'=>'single_digit',
						   	'page_title'=>'Single Digit',
						   	"submit_url"=>panel.'/single_digit/update',
						   	"folder_name"=>'single_digit',
						   	"upload_path"=>'upload/',
						   	"back_btn"=>panel.'/single_digit',
						   	"btn_url"=>panel.'/single_digit/add',
						   	"add_btn_url"=>panel.'/single_digit/add',
						   	"edit_btn_url"=>panel.'/single_digit/edit/',
						   	"view_btn_url"=>panel.'/single_digit/view/',
						   	"controller_name"=>'single_digit',
						   	"page_name"=>'single_digit-detail.php',
						   	"keys"=>'id,name',
   ...
   public function __construct()
	...
	public function view($id="")
	{
		...
		if(!empty($row))
		{
			...
			$data['single_digit_availability'] = $this->db->get_where("single_digit_availability",array("vendor_id"=>$row[0]->vendor_id,))->result_object();
