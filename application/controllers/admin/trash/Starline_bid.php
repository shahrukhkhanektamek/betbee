...
class Starline_bid extends CI_Controller {

   protected $arr_values = array(
						   	'title'=>'Starline Bid', 
						   	'table_name'=>'game_bet',
						   	'page_title'=>'Starline Bid',
						   	"submit_url"=>panel.'/starline_bid/update',
						   	"folder_name"=>'starline_bid',
						   	"upload_path"=>'upload/',
						   	"back_btn"=>panel.'/starline_bid',
						   	"btn_url"=>panel.'/starline_bid/add',
						   	"add_btn_url"=>panel.'/starline_bid/add',
						   	"edit_btn_url"=>panel.'/starline_bid/edit/',
						   	"plan_btn_url"=>panel.'/booking/index/',
						   	"view_btn_url"=>panel.'/starline_bid/view/',
						   	"controller_name"=>'starline_bid',
						   	"page_name"=>'starline_bid-detail.php',
